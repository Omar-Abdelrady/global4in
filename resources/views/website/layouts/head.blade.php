...
<link rel="shortcut icon" href="{{ asset('assets/front-assets/img/favicon.png') }}" type="image/x-icon"/>
<!-- Font Icons css -->
<link rel="stylesheet" href="{{ asset('assets/front-assets/css/font-icons.css') }}">
