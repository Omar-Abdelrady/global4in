            ...
            <div class="col-lg-12">
                <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg text-center---">
                    ...
                    <div class="btn-wrapper">
                        <a class="btn btn-effect-3 btn-white" href="contact.html">تواصل معنا <i
                                class="icon-next"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="footer-widget footer-menu-widget clearfix">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="shop.html">خدمتنا</a></li>
                                <li><a href="locations.html">الاسئلة المتكررة</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-menu-widget clearfix">
                        ...
                        <div class="footer-menu">
                            <ul>
                                <li><a href="order-tracking.html">بيع عقارات</a></li>
                                <li><a href="wishlist.html">ايجارات</a></li>
                                <li><a href="login.html">فيلات</a></li>
                                <li><a href="account.html">بحث متقدم</a></li>
                ...
                <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-menu-widget clearfix">
                        <h4 class="footer-title">حسابى</h4>
                        <div class="footer-menu">
                            <ul>
                                <li><a href="login.html">تسجيل دخول</a></li>
                                <li><a href="account.html">حسابى</a></li>
                                <li><a href="wishlist.html">تسجيل</a></li>
                                <li><a href="order-tracking.html">المفضلة</a></li>
